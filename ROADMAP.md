...
- ~~**2.11 — Rebuild PDF reader from scratch.**~~ **Done, 2026-09-24.** With user
  ...
  - Continuous vertical scroll mode is viewer default and persists across restarts (`reader.pdf.continuous`).
  - Smart crop defaults to OFF, persists per-document (`book.<id>.pdf.smart_crop`), with generous 3.5% (min 24px) padding so glyphs and page numbers are never clipped.
