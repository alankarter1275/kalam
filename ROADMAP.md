...
- ~~**2.11 — Rebuild PDF reader from scratch & UI stabilization.**~~ **Done, 2026-09-25.** With user
  ...
  - English-only OCR (`ocrs` / MuPDF structured text) pipeline planned for text selection.
- **2.12 — Comic Reader UI Modernization & Unification.** Before Bubbles, align the Comic Reader UI,
  floating chrome, and sidebar with the EPUB and PDF readers so all three formats share a unified,
