...
| **Not a library** | `kalam`, `chapbook-viewer-gtk`, `tools/chapbook-cli`, `tools/kalam-reader-demo` | Their surface is an application, a command line or a window, not a Rust API. |
